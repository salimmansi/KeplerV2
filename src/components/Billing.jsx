        ...
        <div className="team-wrapper flex flex-row flex-wrap " data-aos="fade-up"
          ...
          >
            ...
            <figcaption>
              ...
              <div>
                <p> {translate("Director of Event Operations")}</p>
              </div>
              <a href="#"></a>
            </figcaption>
          </figure>
          ...
          >
            ...
            <figcaption>
              <h2>Jinene Dridi</h2>
              <div>
                <p> {translate("Reservation and Ticketing Manager")}</p>
              </div>
              <a href="#"></a>
            </figcaption>
          </figure>
          ...
          >
            ...
            <figcaption>
              ...
              <div>
                <p>{translate("Event Coordinator")}</p>
              </div>
              <a href="#"></a>
            </figcaption>
          </figure>
